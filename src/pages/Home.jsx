    ...
    <>
      ...
      <div className="px-4 sm:mx-12 md:mx-24 my-10 md:my-24 lg:my-32">
        <div className="flex flex-col md:flex-row gap-4 lg:gap-20 justify-evenly items-center">
          <div className="text-center">
            <h1 className="text-xl sm:text-3xl lg:text-5xl pb-4">
          ...
          <div className="relative w-48 sm:w-72 md:w-96 lg:w-full mt-5 sm:mt-2">
            <div className="absolute w-full h-full rounded-tr-lg border rounded-bl-lg border-1 border-dark-one7 right-4 top-4 z-0"></div>
            <img
              src={reg}
              className="w-full rounded-tr-lg rounded-bl-lg z-10 relative"
      ...
      <div className="px-4 sm:mx-12 md:mx-24 my-10 md:my-24">
        ...
        <p className="text-center px-4 sm:px-10 md:px-20 lg:px-44 text-gray-800 text-base sm:text-lg md:text-xl mb-6">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Veritatis,
          iste? Molestias iste recusandae dolorem aperiam omnis aspernatur earum
          atque facere, enim, accusamus ipsum labore saepe, rem fugit incidunt
          molestiae distinctio.
        ...
        <div className="flex justify-center items-center">
          <div className="w-64 sm:w-80 md:w-96 lg:w-[34rem]">
            <Swiper
              effect={"cards"}
              grabCursor={true}
              modules={[EffectCards]}
